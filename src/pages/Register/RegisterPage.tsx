      ...
      <div className="w-full md:w-3/5 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-800">Crie sua conta para iniciar sua jornada como provedor, ou consumidor!</p>
          </div>
          ...
          <div className="text-center">
            <h1 className="text-gray-800">Já tem uma conta? <a href="/login" className="text-blue-500 underline">Entre nela!</a></h1>
          </div>
        </div>
      </div>
    </div>
